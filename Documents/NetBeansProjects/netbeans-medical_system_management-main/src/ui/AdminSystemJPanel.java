...
import ui_doctor.PatientsForDiagnosisJPanel;
...
public class AdminSystemJPanel extends javax.swing.JPanel {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        User user = new User(userType, userName, userPassword);
        UserDirectory userDirectory = initiateUserDirectory();
        if (userDirectory.contains(user)) {
            if (userType.equals("Doctor")) {
                PatientsForDiagnosisJPanel managePatient = new PatientsForDiagnosisJPanel(userProcessContainer, admin);
    ...
    private UserDirectory initiateUserDirectory() {
        UserDirectory userDirectory = new UserDirectory();
        userDirectory.addUser(new User("Doctor", "Ann", "123"));
        userDirectory.addUser(new User("Patient", "James", "111"));
